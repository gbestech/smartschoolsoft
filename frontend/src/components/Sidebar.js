...
const Sidebar = () => {
    ...
    return (
        <div className={`bg-white shadow-lg border-r border-gray-200 flex flex-col transition-all duration-300 fixed left-0 top-0 h-screen z-50 ${isCollapsed ? 'w-20' : 'w-64'
            }`}>
            ...
            {/* Toggle Button for Mobile/External Toggle */}
