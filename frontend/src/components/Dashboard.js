...
//                             <span className="text-gray-800 text-sm font-medium">{stats.totalProducts}</span>
//                         </div>
//                         <div className="flex justify-between items-center py-2">
//                             <span className="text-gray-600">Active Sales</span>
//                             <span className="text-gray-800 text-sm font-medium">{stats.totalSales} today</span>
//                         </div>
//                     </div>

//                     {/* Notifications */}
//                     <div className="mt-6">
//                         <h5 className="text-md font-semibold text-gray-800 mb-3">Notifications</h5>
//                         <div className="space-y-3">
//                             {lowStockProducts.length > 0 && (
...
//                                 <div>
//                                     <p className="text-blue-800 text-sm font-medium">Welcome to Your Dashboard</p>
