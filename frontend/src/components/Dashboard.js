...
//             const totalDebt = salesData.reduce((sum, sale) => sum + parseFloat(sale.balance || 0), 0);

//             // Count unique customers and debtors
//             const uniqueCustomers = new Set(salesData.map(sale => sale.customer_name?.toLowerCase().trim()).filter(Boolean));
//             const totalCustomers = uniqueCustomers.size;

//             // Find debtors (customers with balance > 0)
...
//             // Get top 5 debtors (highest debt)
...
//         navigate('/sales'); // Navigate to sales page where debtors can be managed
//     };
...
//                         <div>
//                             <h3 className="text-sm font-medium text-gray-500">Total Debtors</h3>
...
//                 {/* System Status & Financial Health */}
//                 <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
...
//                     {/* Notifications */}
//                     <div className="mt-6">
//                         <h5 className="text-md font-semibold text-gray-800 mb-3">Alerts</h5>
//                         <div className="space-y-3">
//                             {stats.totalDebt > 0 && (
...
//             const userSalesData = isAdmin ? salesData : salesData.filter(sale => sale.created_by === user?.id);
...
//     const handleViewReports = () => {
//         if (!isAdmin) {
//             alert('Only administrators can access reports');
//             return;
//         }
//         navigate('/reports');
//     };
...
//                     {!isAdmin && <span className="text-blue-600 ml-2">👤 Standard User</span>}
//                 </p>
//             </div>
...
//             {/* Enhanced Stats Overview - Different for Admin vs User */}
//             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
//                 {/* Total Sales - Both can see */}
//                 <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
//                     <div className="flex items-center">
//                         <div className="text-2xl mr-4 text-blue-500">💰</div>
//                         <div>
//                             <h3 className="text-sm font-medium text-gray-500">
//                                 {isAdmin ? 'Total Sales' : 'My Sales'}
//                             </h3>
//                             <p className="text-2xl font-bold text-gray-800">
//                                 {stats.loading ? '...' : stats.totalSales}
//                             </p>
...
//                 {/* Total Revenue - Both can see but different context */}
//                 <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
//                     <div className="flex items-center">
//                         <div className="text-2xl mr-4 text-green-500">📈</div>
//                         <div>
...
//                 {/* Outstanding Debt - Both can see but different context */}
//                 <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
//                     <div className="flex items-center">
//                         <div className="text-2xl mr-4 text-red-500">⚠️</div>
//                         <div>
//                             <h3 className="text-sm font-medium text-gray-500">
//                                 {isAdmin ? 'Outstanding Debt' : 'My Outstanding'}
//                             </h3>
//                             <p className="text-2xl font-bold text-red-600">
//                                 {stats.loading ? '...' : formatCurrency(stats.totalDebt).replace('NGN', '₦')}
//                             </p>
...
//                 {/* Total Debtors - Both can see but different context */}
//                 <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
//                     <div className="flex items-center">
//                         <div className="text-2xl mr-4 text-orange-500">👥</div>
//                         <div>
//                             <h3 className="text-sm font-medium text-gray-500">
//                                 {isAdmin ? 'Total Debtors' : 'My Debtors'}
//                             </h3>
//                             <p className="text-2xl font-bold text-orange-600">
//                                 {stats.loading ? '...' : stats.totalDebtors}
//                             </p>
...
//                 {/* Quick Stats - Different content for Admin vs User */}
//                 <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
//                     <h4 className="text-lg font-semibold text-gray-800 mb-4">
//                         {isAdmin ? 'Business Overview' : 'My Performance'}
//                     </h4>
//                     <div className="grid grid-cols-2 gap-4">
//                         <div className="bg-gradient-to-br from-blue-500 to-blue-600 text-white p-4 rounded-lg text-center">
//                             <div className="text-2xl font-bold">
...
//                             </div>
//                             <div className="text-xs opacity-90 mt-1">
//                                 {isAdmin ? 'Customers' : 'My Customers'}
//                             </div>
//                         </div>
//                         <div className="bg-gradient-to-br from-red-500 to-red-600 text-white p-4 rounded-lg text-center">
//                             <div className="text-2xl font-bold">
...
//                 {/* Top Debtors - Both can see but different context */}
//                 <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
//                     <div className="flex items-center justify-between mb-4">
//                         <h4 className="text-lg font-semibold text-gray-800">
//                             {isAdmin ? 'Top Debtors' : 'My Top Debtors'}
//                         </h4>
//                         <button
//                             onClick={handleViewDebtors}
//                             className="text-blue-500 hover:text-blue-700 text-sm font-medium"
...
//                 {/* System Status & Financial Health - Admin only */}
//                 {isAdmin && (
//                     <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
//                         <h4 className="text-lg font-semibold text-gray-800 mb-4">Financial Health</h4>
//                         <div className="space-y-4">
...
//                 {/* User Performance Summary - For non-admin users */}
//                 {!isAdmin && (
//                     <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
...
//             {/* Quick Actions - Different actions for Admin vs User */}
//             <div className="mt-8 bg-white rounded-lg shadow-sm p-6 border border-gray-200">
//                 <h4 className="text-lg font-semibold text-gray-800 mb-4">Quick Actions</h4>
//                 <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
//                     <button
...
//                             className="flex items-center justify-center space-x-2 bg-gray-500 text-white py-3 px-4 rounded-lg hover:bg-gray-600 transition-colors font-medium"
//                         >
//                             <span>🔒</span>
...
const Dashboard = () => {
    ...
    return (
        <div className="p-6 w-full">
            ...
            {/* Dashboard Widgets - Only show for Admin */}
            {isAdmin && (
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {/* User Performance Summary - Only for Admin (hidden for non-admin) */}
                {isAdmin && (
                    <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
                        <h4 className="text-lg font-semibold text-gray-800 mb-4">My Performance Summary</h4>
                        <div className="space-y-4">
